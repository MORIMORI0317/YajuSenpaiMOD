...
public enum YJArmorMaterials implements ArmorMaterial {
    YJNIUM("yjnium", 19, new int[]{2, 5, 10, 2}, 9, SoundEvents.ARMOR_EQUIP_IRON, 1.4F, 1.4F, () -> {
    ...
    private YJArmorMaterials(String string2, int j, int[] is, int k, SoundEvent soundEvent, float f, float g, Supplier<Ingredient> supplier) {
        this.name = string2;
