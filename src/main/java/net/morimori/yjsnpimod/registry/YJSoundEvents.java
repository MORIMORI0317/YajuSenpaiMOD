...
public class YJSoundEvents {
    ...
    public static final SoundEvent TON_AAIISSUNE = register("ton.aaiissune");
    public static final SoundEvent TON_HAESUGGOIOOKII = register("ton.haesuggoiookii");
    public static final SoundEvent TON_HONOTUNIOOKKIISUNE = register("ton.honotuniookkiisune");
    public static final SoundEvent TON_IYTYOTTOHONTONI = register("ton.iytyottohontoni");
    public static final SoundEvent TON_KYOUHATUKAREMASITAYO = register("ton.kyouhatukaremasitayo");
    public static final SoundEvent TON_MAZUIDESUYO = register("ton.mazuidesuyo");
    public static final SoundEvent TON_NANISURUNSUKA = register("ton.nanisurunsuka");
    public static final SoundEvent TON_SENAPAI = register("ton.senapai");
    public static final SoundEvent TON_TADOKOROSANMAZUIDESUYO = register("ton.tadokorosanmazuidesuyo");
    public static final SoundEvent TON_UMOU = register("ton.umou");
    public static final SoundEvent TON_YAMETEKUDASAIYO = register("ton.yametekudasaiyo");
    public static final SoundEvent TON_YAMETEKUDASAIYOHONOTNI = register("ton.yametekudasaiyohonotni");

    public static final SoundEvent TON_BREAK = register("ton.break");
    public static final SoundEvent TON_PLACE = register("ton.place");
    public static final SoundEvent TON_STEP = register("ton.step");
    public static final SoundEvent TON_HIT = register("ton.hit");
    public static final SoundEvent TON_FALL = register("ton.fall");

    public static final SoundEvent KMR_ARIGATOGOZAIMASU = register("kmr.arigatogozaimasu");
    public static final SoundEvent KMR_E = register("kmr.e");
    public static final SoundEvent KMR_IYAMITENAIDESUYO = register("kmr.iyamitenaidesuyo");
    public static final SoundEvent KMR_IYASONNNAKOTO = register("kmr.iyasonnnakoto");
    public static final SoundEvent KMR_IYAXASONNA = register("kmr.iyaxasonna");
    public static final SoundEvent KMR_NANDEMIRUHITUYOUGAARUNDESUKA = register("kmr.nandemiruhituyougaarundesuka");
    public static final SoundEvent KMR_NAOKIDESU = register("kmr.naokidesu");
    public static final SoundEvent KMR_YAMETEKUREYO = register("kmr.yametekureyo");

    public static final SoundEvent KMR_BREAK = register("kmr.break");
    public static final SoundEvent KMR_PLACE = register("kmr.place");
    public static final SoundEvent KMR_STEP = register("kmr.step");
    public static final SoundEvent KMR_HIT = register("kmr.hit");
    public static final SoundEvent KMR_FALL = register("kmr.fall");

    public static final SoundEvent MUR_ASSOKKA = register("mur.assokka");
    public static final SoundEvent MUR_ATARIMAEDAYONA = register("mur.atarimaedayona");
    public static final SoundEvent MUR_ATTU = register("mur.attu");
    public static final SoundEvent MUR_DOUSUKKANA = register("mur.dousukkana");
    public static final SoundEvent MUR_HARAHETTANA = register("mur.harahettana");
    public static final SoundEvent MUR_IIZOKORE = register("mur.iizokore");
    public static final SoundEvent MUR_IKITEENA = register("mur.ikiteena");
    public static final SoundEvent MUR_MIROYOMIROYO = register("mur.miroyomiroyo");
    public static final SoundEvent MUR_MITAKERYAMISETEYARUYO = register("mur.mitakeryamiseteyaruyo");
    public static final SoundEvent MUR_OIMATE = register("mur.oimate");
    public static final SoundEvent MUR_OSSUDANA = register("mur.ossudana");
    public static final SoundEvent MUR_POTTYAMA = register("mur.pottyama");
    public static final SoundEvent MUR_SOUDAYO = register("mur.soudayo");
    public static final SoundEvent MUR_SUGGEKITUKATTAZO = register("mur.suggekitukattazo");
    public static final SoundEvent MUR_TIRATIRAMITETADARO = register("mur.tiratiramitetadaro");
    public static final SoundEvent MUR_URESIIDARO = register("mur.uresiidaro");
    public static final SoundEvent MUR_USOTUKEZETTAIMITETAZO = register("mur.usotukezettaimitetazo");

    public static final SoundEvent MUR_BREAK = register("mur.break");
    public static final SoundEvent MUR_PLACE = register("mur.place");
    public static final SoundEvent MUR_STEP = register("mur.step");
