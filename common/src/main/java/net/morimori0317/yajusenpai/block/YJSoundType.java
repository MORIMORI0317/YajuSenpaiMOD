...
public class YJSoundType extends SoundType {
    ...
    public static final Supplier<SoundType> MEZIKARA = createYJSoundType(10f, YJSoundEvents.MEZIKARA_HONTAI, YJSoundEvents.MEZIKARA_NS, YJSoundEvents.MEZIKARA_MAEBURI, YJSoundEvents.MEZIKARA_NS, YJSoundEvents.MEZIKARA_MAEBURI);
