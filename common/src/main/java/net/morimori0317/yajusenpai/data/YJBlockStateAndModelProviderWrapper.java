...
public class YJBlockStateAndModelProviderWrapper extends BlockStateAndModelProviderWrapper {
    public YJBlockStateAndModelProviderWrapper(PackOutput packOutput, CrossDataGeneratorAccess crossDataGeneratorAccess) {
        super(packOutput, crossDataGeneratorAccess);
    }

    @Override
    public void generateStatesAndModels(BlockStateAndModelProviderAccess providerAccess) {
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_INTERVIEW_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_GOMANETSU_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_ENNUI_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_MEZIKARA_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_NEHAN_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_SHITARIGAO_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_IKISUGI_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_IMDKUJ_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_KUNEKUNE_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_SZKFK_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_CCCLKTJM_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_CWCWTD_BLOCK.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_INTLNGTM_BLOCK.get());
        ...
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.YJSNPI_ORE.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.DEEPSLATE_YJNIUM_ORE.get());
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.DEEPSLATE_YJSNPI_ORE.get());
        ...
        providerAccess.simpleCubeBlockStateModelAndItemModel(YJBlocks.RAW_YJSNPI_BLOCK.get());
    ...
    private void yjProliferationBlock(BlockStateAndModelProviderAccess providerAccess) {
        FileModel model = providerAccess.cubeAllBlockModel(YJBlocks.YJSNPI_PROLIFERATION_BLOCK.get(), ModelLocationUtils.getModelLocation(YJBlocks.YJSNPI_INTERVIEW_BLOCK.get()));
        providerAccess.simpleBlockState(YJBlocks.YJSNPI_PROLIFERATION_BLOCK.get(), model);
        providerAccess.simpleBlockItemModel(YJBlocks.YJSNPI_PROLIFERATION_BLOCK.get(), model);
    }

    private void yjsnpiExplodingBlock(BlockStateAndModelProviderAccess providerAccess) {
        for (int i = 0; i < 147; i++) {
            ModelTemplates.CUBE_ALL.create(modLoc("block/yjsnpi_exploding_block/yj_" + i), TextureMapping.cube(modLoc("block/yjsnpi_exploding_block/yj_" + i)), providerAccess.modelOutput());
        }

        MultiVariantGenerator generator = MultiVariantGenerator.multiVariant(YJBlocks.YJSNPI_EXPLODING_BLOCK.get())
                .with(PropertyDispatch.properties(YJExplodingBlock.YJ_START, YJExplodingBlock.YJ_TIMER).generate(new BiFunction<Boolean, Integer, Variant>() {
                    @Override
                    public Variant apply(Boolean aBoolean, Integer integer) {
                        if (!aBoolean) {
                            return Variant.variant().with(VariantProperties.MODEL, modLoc("block/yjsnpi_ikisugi_block"));
                        }

                        return Variant.variant().with(VariantProperties.MODEL, modLoc("block/yjsnpi_exploding_block/yj_" + integer));
                    }
                }));
        providerAccess.addBlockStateGenerator(generator);

        providerAccess.simpleBlockItemModel(YJBlocks.YJSNPI_EXPLODING_BLOCK.get(), providerAccess.existingModel(ModelLocationUtils.getModelLocation(YJBlocks.YJSNPI_IKISUGI_BLOCK.get())));
    }
