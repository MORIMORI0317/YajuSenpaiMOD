...
public class YJBlockTagProviderWrapper extends BlockTagProviderWrapper {
    public YJBlockTagProviderWrapper(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookup, CrossDataGeneratorAccess crossDataGeneratorAccess) {
    ...
    public void generateTag(IntrinsicTagProviderAccess<Block> providerAccess) {
        ...
        providerAccess.tag(BlockTags.MINEABLE_WITH_PICKAXE)
                .add(YJBlocks.YJ_STONE.get(), YJBlocks.YJ_DEEPSLATE.get(), YJBlocks.YJNIUM_ORE.get(),
                        YJBlocks.YJSNPI_ORE.get(), YJBlocks.DEEPSLATE_YJNIUM_ORE.get(), YJBlocks.DEEPSLATE_YJSNPI_ORE.get(),
                        YJBlocks.YJNIUM_BLOCK.get(), YJBlocks.RAW_YJNIUM_BLOCK.get(), YJBlocks.RAW_YJSNPI_BLOCK.get(),
        ...
        providerAccess.tag(YJBlockTags.YJSNPI_ORES)
                .add(YJBlocks.YJSNPI_ORE.get(), YJBlocks.DEEPSLATE_YJSNPI_ORE.get());

        providerAccess.tag(YJBlockTags.YJSNPI_BLOCK)
                .add(YJBlocks.YJSNPI_INTERVIEW_BLOCK.get(), YJBlocks.YJSNPI_GOMANETSU_BLOCK.get()
                        , YJBlocks.YJSNPI_ENNUI_BLOCK.get(), YJBlocks.YJSNPI_MEZIKARA_BLOCK.get()
                        , YJBlocks.YJSNPI_NEHAN_BLOCK.get(), YJBlocks.YJSNPI_SHITARIGAO_BLOCK.get()
                        , YJBlocks.YJSNPI_IKISUGI_BLOCK.get(), YJBlocks.YJSNPI_IMDKUJ_BLOCK.get()
                        , YJBlocks.YJSNPI_KUNEKUNE_BLOCK.get(), YJBlocks.YJSNPI_SZKFK_BLOCK.get()
                        , YJBlocks.YJSNPI_CCCLKTJM_BLOCK.get(), YJBlocks.YJSNPI_CWCWTD_BLOCK.get()
                        , YJBlocks.YJSNPI_INTLNGTM_BLOCK.get());
