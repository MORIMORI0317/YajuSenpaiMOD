...
public class YJStructurePieceType {
    private static final DeferredRegister<StructurePieceType> STRUCTURE_PIECE_TYPES = DeferredRegister.create(YajuSenpai.MODID, Registry.STRUCTURE_PIECE_REGISTRY);
