...
public class YJBiomes {
    public static Biome createYJBiome(BootstapContext<Biome> context) {
        ...
        BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder(context.lookup(Registries.PLACED_FEATURE), context.lookup(Registries.CONFIGURED_CARVER));
